# CSE423 Assignment 1: 3D Graphics & Animation with OpenGL

<div align="center">

**A professional implementation of 3D graphics tasks using Python and OpenGL**
...
[Features](#features) • [Installation](#installation) • [Usage](#usage) • [Tasks](#tasks) • [Controls](#controls)
...
This assignment demonstrates professional 3D graphics programming using Python's OpenGL bindings. It includes two interactive tasks showcasing advanced graphics techniques such as:

- **Real-time 3D Rendering**: Hardware-accelerated graphics with smooth animation
- **Physics Simulation**: Realistic rain particle system with directional control
- **Interactive Controls**: Responsive keyboard and mouse input
- **State Management**: Complex application state handling and rendering pipelines
...
A complete 3D scene with dynamic weather simulation:

- 🏠 **Detailed House Architecture**
  - Multi-layer construction with foundation, walls, and roof
  - Realistic door and window design with warm lighting
  - Professional brick texture and color gradients

- 🌳 **Natural Environment**
  - Multiple trees with varied sizes and positions
  - Green grass field with directional grass lines
  - Proper spatial arrangement and perspective
